...
function preload() {
    part1Img = loadImage('assets/head1.png', () => console.log('part1Img loaded'), () => console.error('Failed to load part1Img'));
    part2Img = loadImage('assets/head2.png', () => console.log('part2Img loaded'), () => console.error('Failed to load part2Img'));
    part3Img = loadImage('assets/head3.png', () => console.log('part3Img loaded'), () => console.error('Failed to load part3Img'));
    part4Img = loadImage('assets/head4.png', () => console.log('part4Img loaded'), () => console.error('Failed to load part4Img'));
...
function draw() {
    ...
    if (shield.isComplete() || keyIsDown(71)) {
        ...
        textAlign(CENTER, CENTER);
        if (!videoplay) {
            text('Head completed!', width / 2, height - 75);
        }
